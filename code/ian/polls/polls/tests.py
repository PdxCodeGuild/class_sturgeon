...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        """ Ensures questions older than a day dont show recent"""
...
class QuestionIndexViewTest(TestCase):
    ...
    def test_two_past_question(self):
        ...
        question1 = create_question(question_text="Past question", days=-30)
        question2 = create_question(question_text="Pas question", days=-5)
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(
            response.context['latest_question_list'],
            [question2, question1]
...
class QuestonDetailViewTest(TestCase):
    ...
    def test_past_question(self):
        """ test eto ensure questions older than now show properly"""
