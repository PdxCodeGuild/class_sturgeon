...
class QuestionModelTests(TestCase):
    """It showed a post in the future as having been published recently"""
...
class QuestionIndexViewTest(TestCase):
    ...
    def test_future_question(self):
        """
        Questions with a pub_date in the future aren't displayed yet.
        """
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        """Ensures Future posts cannot be seen in detail"""
    ...
    def test_past_question(self):
        """Questions older than now show properly"""
